...
const Navbar = () => {
    ...
    return (
        <View style={[styles.container]}>
            <TouchableOpacity style={[styles.button, { paddingBottom: insets.bottom }]} onPress={() => router.navigate("/leaderboard")}>
            ...
            <TouchableOpacity style={[styles.button, { paddingBottom: insets.bottom }]} onPress={() => router.navigate("/home")}>
            ...
            <TouchableOpacity style={[styles.button, { paddingBottom: insets.bottom }]} onPress={() => router.navigate("/settings")}>
